namespace ValetService.Migrations
{
    ...
    public partial class PortalComplete : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IDCardNumber = c.String(nullable: false, maxLength: 14),
                ...
                c => new
                    {
                        ...
                        InitialPeriod = c.Int(nullable: false),
                        IntitalRate = c.Decimal(nullable: false, precision: 18, scale: 2),
                ...
                c => new
                    {
                        ...
                        LicencePlateNumber = c.String(nullable: false),
                        Status = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Vehicles", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.Tickets", new[] { "CreatedAt" });
            DropIndex("dbo.Zones", new[] { "Organization_Id" });
            DropIndex("dbo.Zones", new[] { "CreatedAt" });
            DropIndex("dbo.Tags", new[] { "Organization_Id" });
